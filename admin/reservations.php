...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="content">
            ...
            echo '<td class="addNew"><a id="edit" href="add/addreservation.php">Add</a> </td>';
            ...
            foreach (array_slice($data, $startIndex, $itemsPerPage) as $reserve) {
                ...
                echo 'Partner ID: ' . (isset($reserve['parking']['partner']['id']) ? $reserve['parking']['partner']['id'] : 'N/A') . '<br>';                echo 'Max spot count: ' . $reserve['parking']['maxSpotsCount'] . '<br>';
