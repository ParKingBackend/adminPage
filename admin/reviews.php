    ...
    <div class="grid-container">
        ...
        <div class="content">
            ...
            foreach (array_slice($data, $startIndex, $itemsPerPage) as $reserve) {
                ...
                echo 'Partner ID: ' . (isset($reserve['parking']['partner']['id']) ? $reserve['parking']['partner']['id'] : 'N/A') . '<br>';  
