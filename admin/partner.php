...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="content">
            <?php
            $endpoint = '/api/partners/get/all'; // Adjust the endpoint as needed
            ...
            echo '<th><a href="?sort=name&order=asc">Name &#8593;</a> <a href="?sort=name&order=desc">Name &#8595;</a></th>';
            echo '<th><a href="?sort=bankAccount&order=asc">Bank Account &#8593;</a> <a href="?sort=bankAccount&order=desc">Bank Account &#8595;</a></th>';
            echo '<td class="addNew"><a id="edit" href="add/addpartner.php">Add</a> </td>';
            echo '</tr>';
